...
import { UsersEditComponent } from "./corporativo/users-edit/users-edit.component";
...
@NgModule({
  declarations: [AppComponent, FullLayoutComponent, ContentLayoutComponent,UsersEditComponent],
  imports: [
